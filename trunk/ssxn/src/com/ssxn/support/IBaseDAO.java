...
public interface IBaseDAO<T, PK extends Serializable> extends ISimpleDAO<T, PK> {
	...
	public abstract Page findPage(final BasePageVO pv, final String hql, final Object... values);
	 ...
	 * @return Page 分页查询结果.
	 */
	public abstract Page findPage(final BasePageVO vo, final String hql, final Map<String, Object> values);
	 ...
	 */
	public abstract Page findPageBySQL(final BasePageVO pv, final String sql, final Map<String, Object> values);
	 ...
	 * @return Page 分页查询结果.result里面是Map对象.
	 */
	public abstract Page findPageBySQL(final BasePageVO pv, final String sql, final Object... values);
	...
	public abstract Page findAll(BasePageVO pv);
}