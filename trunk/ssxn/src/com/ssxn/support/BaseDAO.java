...
public class BaseDAO<T, PK extends Serializable> extends SimpleDAO<T, PK> implements IBaseDAO<T, PK> {
	...
	public Page findPage(final BasePageVO vo, final String hql, final Object... values) {
	...
	public Page findPage(final BasePageVO vo, final String hql, final Map<String, Object> values) {
	...
	public Page findPageBySQL(BasePageVO vo, String sql, Map<String, Object> values) {
		Assert.notNull(vo, "page不能为空");
	...
	public Page findPageBySQL(BasePageVO vo, String sql, Object... values) {
		Assert.notNull(vo, "page不能为空");
	...
	public Page findAll(BasePageVO pv) {
		return this.findPage(pv, "from " + this.getTableName());
	}
